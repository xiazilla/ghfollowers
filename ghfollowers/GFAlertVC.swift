...
class GFAlertVC: UIViewController {
    ...
    func configureContainerView() {
        ...
        NSLayoutConstraint.activate([
            ...
            containerView.heightAnchor.constraint(equalToConstant: 220) // could make this dynamic if you're a tryhard
        ])
    ...
    func configureBodyLabel() {
        ...
        bodyLabel.text = messageTitle ?? "Unable to complete request"
